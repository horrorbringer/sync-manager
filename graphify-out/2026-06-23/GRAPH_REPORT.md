...
## Corpus Check
- 36 files · ~25,818 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 308 nodes · 658 edges · 17 communities (16 shown, 1 thin omitted)
...
Cohesion: 0.13
Nodes (9): register_commands(), create_app(), User, app(), test_viewer_cannot_access_notification_settings(), test_viewer_cannot_create_connection(), test_disabled_user_cannot_login(), test_viewer_cannot_access_user_management() (+1 more)

### Community 3 - "Notifications and Security"
Cohesion: 0.12
Nodes (22): settings(), test_message(), get_settings(), init_notification_executor(), _send_in_app(), send_telegram_message(), init_celery(), NotificationSettings (+14 more)

### Community 4 - "Community 4"
Cohesion: 0.12
Nodes (25): dependency_report(), expand_tables_with_dependencies(), incremental_checkpoint_status(), SyncProfile, _all_table_names(), checkpoint_status(), create(), _dry_run_with_filters() (+17 more)

### Community 5 - "Authentication and Connections"
Cohesion: 0.13
Nodes (22): login(), logout(), _connection_fields(), _connection_form_values(), create(), delete(), edit(), index() (+14 more)
...
- **Why does `SyncJob` connect `Models and Audit Logs` to `Sync Engine`, `Notifications and Security`, `Community 4`, `Authentication and Connections`, `Sync Engine Tests`, `Job Task Execution`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `DatabaseConnection` connect `Models and Audit Logs` to `Notifications and Security`, `Community 4`, `Authentication and Connections`, `Sync Engine Tests`, `Job Task Execution`?**
